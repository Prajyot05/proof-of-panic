...
pub mod target_perp {
    ...
    pub fn apply_circuit_breaker(ctx: Context<ApplyCircuitBreaker>) -> Result<()> {
        ...
        require!(risk_engine_state.circuit_breaker_active, TargetError::CircuitBreakerNotActive);
        ...
        msg!("Reducing max leverage from {}x to {}x", perp_state.max_leverage / 1_000_000, new_leverage / 1_000_000);
